            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%" style="width:100%; margin: 0; font-family: 'Titillium Web', sans-serif; font-size: 14px;">
                ...
                <tr>
                    <td>
                        ...
                        <p style="margin: 0;">Your account has been created on '<a href="{{'url('/')'}}" style="color: #0D52B9; text-decoration: none;">Inboxly App</a>'. <br>Please log in to the application with the below credentials to start using your account.</p>
