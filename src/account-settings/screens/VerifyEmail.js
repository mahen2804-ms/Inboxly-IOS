...
import { validateOTPAction, reSendOTPAction } from '../../redux/actions';
...
function VerifyEmail(props) {
    ...
    useEffect(() => {
        if(props.route && props.route.params && props.route.params.newEmail) {
            const newEmail = props.route.params.newEmail;
    ...
    const handleback = () => {
        Alert.alert(
            "Alert",
            "If you go back you lost your data",
            [
                {
                    text: "Cancel",
                                ...
                                {({ handleSubmit }) => (
                                    <>
                                        ...
                                        <View style={innerStyle.inputFieldStyle}>
                                            ...
                                            <TouchableOpacity style={innerStyle.backToLoginViewStyle} onPress={() => handleback()}>
                                                <Text style={innerStyle.backToLoginTextStyle}>
                                                    {LABELS.BACK}
                                                </Text>
                                            </TouchableOpacity>
...
export default connect(mapStateToProps, { validateOTPAction, reSendOTPAction })(VerifyEmail);