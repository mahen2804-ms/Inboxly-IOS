...
class NewsSenders extends Component {
    ...
    renderList = () => {
        return (
            <FlatList
                data={
                    this.props.senderData && this.props.senderData.length > 0
                        ? this.props.senderData
                        : this.state.itemList
                }
    ...
    handleEditCategory = () => {
        const { selectedSenderId, selectedCategories, selectedCatId } =
            this.state;
        this.props.navigation.navigate("EditCategoryList", {
            feedId: selectedSenderId,
            categoryData: selectedCategories,
            selectedSender: selectedCatId,
        });
    };
            ...
            if (this.state.showFilter) {
                this.props.getSnoozeListAction(requestData, (res) => {
                    if (
                        ...
                        res.data.success.data.length > 0
                    ) {
        ...
        return (
            <Container>
                ...
                <MainHeader
                    leftButtonType={"menu"}
                    leftButton={true}
                    rightButtonType={"snooze"}
                    rightButton={true}
                    title={
                        showFilter
                            ? LABELS.SNOOZED_SENDER
