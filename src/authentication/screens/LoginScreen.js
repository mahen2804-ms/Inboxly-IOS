            ...
            if (fcmTokenVal !== null) {
                ...
                props.loginUserAction(requestData, (res) => {
                    ...
                    if (res.status === STATUS_CODES.OK) {
                        ...
                        console.log(
                            "print login data....",
                            res.data.success.data.userDetail.is_first_time
                        );
        ...
        <Container>
                                    ...
                                    <>
                                        ...
                                        <View style={innerStyle.textFiledStyle}>
                                            ...
                                            <TouchableOpacity
                                                ...
                                                style={innerStyle.forgotView}
                                            >
                                                <Text
                                                    style={
                                                        innerStyle.forgotPasswordStyle
                                                    }
                                                >
                                        ...
                                        <View style={innerStyle.bottomView}>
                                            <TouchableButton
                                                ...
                                                buttonContainer={
                                                    innerStyle.buttonContainer
                                                }
                                                buttonTextStyle={
                                                    innerStyle.buttonTextStyle
                                                }
                                            />
                                        </View>
                                    </>
            ...
            >
                <Text style={innerStyle.registerStyle}>
                    ...
                    <Text
                        style={[innerStyle.registerStyle, { color: "#00A6FF" }]}
                    >
                        {LABELS.CREATE_NOW}
                    </Text>
                </Text>
